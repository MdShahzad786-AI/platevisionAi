  ...
  if (history.length === 0) {
    return (
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 text-center text-slate-400">
        <p>No stats available yet. Start scanning!</p>
      </div>
    );
  }
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-slate-800/50 border border-slate-700 p-4 rounded-xl">
          <p className="text-slate-400 text-sm">Plates Found</p>
        ...
        <div className="bg-slate-800/50 border border-slate-700 p-4 rounded-xl">
           <p className="text-slate-400 text-sm">Latest Region</p>
           <p className="text-xl font-mono text-blue-300 truncate mt-1">
             {allDetections[0]?.region || "N/A"}
           </p>
        </div>
      </div>
      ...
      <div className="bg-slate-800/50 border border-slate-700 p-4 rounded-xl h-64">
        <p className="text-slate-400 text-sm mb-4">Vehicle Types</p>
